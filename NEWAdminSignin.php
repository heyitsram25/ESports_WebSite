        ...
        <div class="" style="margin-top:50px">
            <div class="rounded d-flex justify-content-center">
                ...
                style="width: 185px;" alt="logo">
                        <h3 class="text-primary">Admin Sign In</h3>
                    </div>
                ...
                <?php }
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-center mt-5">Are you a customer?									
                                    ...
                                    <p class="text-center mt-5">Login as Employee?									
                                    <span class="text-primary"><a href="page.php">Log In As Employee</a></span>
                                    <p class="text-center mt-5">Login as Manager?									
                                    <span class="text-primary"><a href="newmanagersignin.php">Log In As Manager</a></span>
                                </p>   
                            </div>                                                        
                        </div>
                    </form>
